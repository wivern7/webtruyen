...
<div class="navbar navbar-default navbar-static-top" role="navigation" id="nav">
  ...
  <li>
                    @if(Auth::user())
                        <a href="{{ route("dashboard.index") }}"><span class="glyphicon glyphicon-cog"></span>  Bảng Quản Trị</a>
                    @else
...
<form class="navbar-form navbar-right" action="{{ route('danhsach.search') }}" role="search" itemprop="potentialAction" itemscope="" itemtype="http://schema.org/SearchAction">
